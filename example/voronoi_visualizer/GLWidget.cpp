...
void GLWidget::setPrimaryEdgesOnly(bool primary_edges_only)
{
  primary_edges_only_ = primary_edges_only;
  update();
}

void GLWidget::setInternalEdgesOnly(bool internal_edges_only)
{
  internal_edges_only_ = internal_edges_only;
  update();
}

int GLWidget::get_point_count() { return point_count_; }
int GLWidget::get_segment_count() { return segment_count_; }
